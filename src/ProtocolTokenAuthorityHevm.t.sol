...
// import {MockSurplusAuctionHouse} from "./geb/MockSurplusAuctionHouse.sol";
//
// interface ERC20 {
...
//         MockSurplusAuctionHouse surplusAuctionHouse = new MockSurplusAuctionHouse(address(this), address(protocolToken));
//         auth.addAuthorization(address(debtAuctionHouse));
//
